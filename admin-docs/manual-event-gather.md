...
[Event Gather GitHub Action Page](https://github.com/akgood/cdp-ann-arbor/actions/workflows/event-gather-pipeline.yml).
...
[Process Special Event GitHub Action Page](https://github.com/akgood/cdp-ann-arbor/actions/workflows/process-special-event.yml).
