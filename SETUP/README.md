...
1.  Create the GitHub repository for this deployment to live in.
    ...
    -   Set the repo name to: **cdp-ann-arbor**
    -   Set the repo owner to: **akgood**
...
1.  Create (or re-use) a
    [Google Cloud billing account](https://console.cloud.google.com/billing/linkedaccount?project=cdp-ann-arbor-mytqnzzk)
    and attach it to the newly created project (cdp-ann-arbor-mytqnzzk).
...
1.  Generate a Google Service Account JSON Key for your Google Cloud Project.
    ...
    add a file called `cdp-ann-arbor-mytqnzzk.json` to it
    (i.e. `.keys/cdp-ann-arbor-mytqnzzk)`. This file will be used later on.
...
1.  Attach the Pulumi Access Token and the
    ...
    1. Pulumi Access Token -- Create a [new secret](https://github.com/akgood/cdp-ann-arbor/settings/secrets/actions/new)

    -   Set the name to: **PULUMI_ACCESS_TOKEN**
    -   Set the value to: The token you kept from step #2
    -   Click "Add secret"

    2. Google Service Account JSON -- Create a [new secret](https://github.com/akgood/cdp-ann-arbor/settings/secrets/actions/new)

    -   Set the name to: **GOOGLE_CREDENTIALS**
    -   Set the value to: the contents of the file `.keys/cdp-ann-arbor-mytqnzzk.json`
    -   Click "Add secret"
...
1.  Initialize and push the local repository to GitHub.
    ...
    ```bash
    git remote add origin https://github.com/akgood/cdp-ann-arbor.git
    ```

    Or (with SSH):

    ```bash
    git remote add origin git@github.com:akgood/cdp-ann-arbor.git
    ```
...
1.  Once the
    ["Web App" GitHub Action Successfully Complete](https://github.com/akgood/cdp-ann-arbor/actions?query=workflow%3A%22Web+App%22)
    configure GitHub Pages.

    Go to your repository's [GitHub Pages Configuration](https://github.com/akgood/cdp-ann-arbor/settings/pages)
...
1.  Once the
    ["Infrastructure" GitHub Action Successfully Completes](https://github.com/akgood/cdp-ann-arbor/actions?query=workflow%3A%22Infrastructure%22)
...
1.  Once the
    ...
    [Direct Link to Enable](https://console.cloud.google.com/apis/api/speech.googleapis.com/data_logging?project=cdp-ann-arbor-mytqnzzk)
...
1.  Once the
    ...
    -   Navigate to [Firebase Console](https://console.firebase.google.com),
        login to the Google Account you used during step #2, select the `cdp-ann-arbor-mytqnzzk` Firebase project
...
**If all steps complete successful your web application will be viewable at: https://akgood.github.io/cdp-ann-arbor**
...
Navigate and follow the instructions in the the file: `python/cdp_ann_arbor_backend/scraper.py`.
